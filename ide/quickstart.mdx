...
CODE 모드에서 AI가 파일을 수정하면 Diff 에디터에서 변경 내용을 확인할 수 있습니다. VS Code 툴바의 **`<->` (Diff) 아이콘**을 클릭하면 Diff 에디터가 열립니다.

![Diff 에디터 및 채팅 패널](../images/IDE_DIFF.png)
...
AI가 작업을 마치면 채팅 패널에 수행한 내용 요약과 변경된 파일 목록이 표시됩니다.

![작업 완료 및 리뷰](../images/IDE_COMPLETE_1.png)

응답 하단에는 **Turn Keep** 버튼과 AI가 참조한 문서·파일 목록을 펼쳐볼 수 있습니다.

- **Turn Keep** — 이번 턴의 변경 사항을 최종 확정
- **참조 문서** — AI가 응답 생성에 사용한 파일과 컨텍스트 확인

![Turn Keep 및 참조 문서](../images/IDE_COMPLETE_2.png)
