...
| Setting | Description |
|------|------|
| **Backend URL** | Your organization's server address |
| **Auth Mode** | Authentication method (social login / username-password / standalone) |

<Tip>
Organization administrators often set these values in advance at deployment time. If the sign-in screen appears correctly with the defaults, you don't need to change anything.
</Tip>
