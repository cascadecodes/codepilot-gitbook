...
![Choosing the API key source](/images/en/IDE_MODEL_KEY_SOURCE.png)
...
<Steps>
  <Step title="Add a model">
    ...
    ![Adding a custom model](/images/en/IDE_MODEL_ADD.png)
  </Step>
  ...
  <Step title="Select a provider">
    ...
    ![Gemini model form](/images/en/IDE_MODEL_FORM_GEMINI.png)
  </Step>
  ...
  <Step title="Test, then select">
    ...
    ![Testing and selecting the model](/images/en/IDE_MODEL_TEST.png)
