...
<Steps>
  ...
  <Step title="Go to the Account tab">
    ...
    ![Account tab](/images/en/IDE_ACCOUNT.png)
  </Step>
  ...
  <Step title="Enter the API key">
    ...
    ![Registering the organization API key](/images/en/IDE_ACCOUNT_ORG.png)
  </Step>
...
![Selecting a project](/images/en/IDE_PROJECT_SELECT.png)
