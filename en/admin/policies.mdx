...
Policies configured in CodePilot Admin are automatically applied to your team members' CodePilot IDE and CLI. For flexible operation, CodePilot offers policies at **two enforcement levels**.
