...
<Steps>
  <Step title="Sign in or sign up">
    Go to [https://codepilot.banya.ai](https://codepilot.banya.ai) and sign in with an administrator account. On-premises environments use their own internally deployed address.
  </Step>
