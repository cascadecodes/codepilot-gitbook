...
스크린샷, 디자인 시안, 에러 화면 등 **이미지를 채팅에 첨부**하면 AI가 분석하고 대응합니다.

* **UI 구현**: 디자인 시안 이미지를 첨부하면 해당 화면을 구현하는 코드 생성
* **에러 화면 분석**: 에러가 표시된 브라우저 스크린샷을 첨부하면 원인 분석 및 수정 제안
* **다이어그램 해석**: 아키텍처 다이어그램이나 플로우차트를 읽고 해당 구조에 맞는 코드 작성

{% hint style="info" %}
**고객 가치**

* 텍스트로 설명하기 어려운 요구사항도 **이미지 한 장으로 전달 가능**
* 디자인 → 코드 변환 과정의 **커뮤니케이션 비용 절감**
{% endhint %}
